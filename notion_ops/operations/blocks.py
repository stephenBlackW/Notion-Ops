...
class AsyncBlockOperations:
    """Async CRUD operations for Notion blocks."""
    ...
    async def get_children(
        ...
        *,
        ...
        """
        Get child blocks of a block or page (async).
    ...
    async def append(
        ...
        *,
        ...
        """
        Append blocks to a parent block or page (async).
    ...
    async def archive(self, block_id: str) -> Block:
        """
        Archive a block (same as delete) (async).
    ...
    async def get_child_pages(
        ...
        *,
        ...
        """
        List child pages under a parent block or page (async).
        ...
        while True:
            ...
            for block_data in response.get("results", []):
                ...
                if include_content:
                    info = await self._read_child_page_content(
                        info, max_blocks=max_content_blocks
                    )
    ...
    async def _read_child_page_content(
        self, info: ChildPageInfo, *, max_blocks: int = 50
    ) -> ChildPageInfo:
