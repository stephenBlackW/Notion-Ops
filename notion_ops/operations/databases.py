...
class AsyncDatabaseOperations:
    """Async CRUD operations for Notion databases (containers)."""
    ...
    async def get(self, database_id: str) -> Database:
        """
        Retrieve a database by ID (async).
    ...
    async def update(
        ...
        *,
        ...
        """
        Update database metadata and schema (async).
    ...
    async def list_data_sources(self, database_id: str) -> list[DataSource]:
        """
        List all data sources in a database (async).
